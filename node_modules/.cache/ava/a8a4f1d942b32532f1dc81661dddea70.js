...
test('All pass', function () {
  var _ref = (0, _asyncToGenerator3.default)(_index2.default.mark(function _callee(t) {
    ...
    var allPassWorkflow, runner, results;
    return _index2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            allPassWorkflow = require('./fixtures/all-pass');
            runner = new Runner(allPassWorkflow);
            _context.next = 4;
            return runner.start();
          ...
          case 4:
            ...
            t.is(_rec._expr(_rec._capt(_rec._capt(results, 'arguments/0/object').length, 'arguments/0'), {
              content: 't.is(results.length, 4, \'Right number of tasks pass\')',
              filepath: 'test/index.js',
              line: 13,
              async: true,
              ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"is","range":[2,4]},"computed":false,"range":[0,4]},"arguments":[{"type":"MemberExpression","object":{"type":"Identifier","name":"results","range":[5,12]},"property":{"type":"Identifier","name":"length","range":[13,19]},"computed":false,"range":[5,19]},{"type":"NumericLiteral","value":4,"range":[21,22]},{"type":"StringLiteral","value":"Right number of tasks pass","range":[24,52]}],"range":[0,53]}',
              tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"name"},"value":"is","range":[2,4]},{"type":{"label":"("},"range":[4,5]},{"type":{"label":"name"},"value":"results","range":[5,12]},{"type":{"label":"."},"range":[12,13]},{"type":{"label":"name"},"value":"length","range":[13,19]},{"type":{"label":","},"range":[19,20]},{"type":{"label":"num"},"value":4,"range":[21,22]},{"type":{"label":","},"range":[22,23]},{"type":{"label":"string"},"value":"Right number of tasks pass","range":[24,52]},{"type":{"label":")"},"range":[52,53]}]',
              visitorKeys: _powerAssertVisitorKeys
            }), 4, 'Right number of tasks pass');
...
//# sourceMappingURL=../node_modules/.cache/ava/a8a4f1d942b32532f1dc81661dddea70.js.map